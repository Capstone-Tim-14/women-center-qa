...
public class JsonSchema {
    ...
    public static final String REGISTER_ADMIN_SCHEMA = "schema/register_admin_schema.json";
    public static final String REGISTER_DATA_KOSONG = "schema/register_data_kosong_schema.json";
    public static final String EMAIL_SUDAH_TERDAFTAR = "schema/email_sudah_terdaftar_schema.json";
    public static final String UNAUTHORIZED_MESSAGE = "schema/unauthorized_schema.json";
    public static final String LOGIN = "schema/login_schema.json";
    public static final String DATA_TIDAK_LENGKAP_SCHEMA = "schema/data_tidak_lengkap_schema.json";
    public static final String GET_ALL_ROLES_SCHEMA = "schema/get_all_roles_schema.json";
